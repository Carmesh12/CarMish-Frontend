...
export function VehicleDetailPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([vehiclesApi.getById(id), vehiclesApi.getImages(id)])
      ...
      .catch(() =>
        notifyError(t("detail.fetchError", "Failed to load vehicle")),
      )
  ...
  if (!vehicle) {
    return (
      <div className="min-h-screen bg-mesh-bg flex flex-col items-center justify-center gap-4">
        <p className="text-mesh-muted text-lg">
          {t("detail.notFound", "Vehicle not found")}
        </p>
        <Link to="/vehicles">
  ...
  const selectedImageUrl = selectedImage
    ? resolveMediaUrl(selectedImage.imageUrl)
    : null;
  const canBuy =
  ...
  const specs = [
    {
      ...
      label: t("detail.year", "Year"),
      value: vehicle.year,
    },
    {
      icon: <Cog size={18} />,
      label: t("detail.brand", "Brand"),
      value: vehicle.brand,
    },
    {
      icon: <Cog size={18} />,
      label: t("detail.model", "Model"),
      value: vehicle.model,
    },
    {
      icon: <Fuel size={18} />,
    ...
    {
      icon: <Gauge size={18} />,
      label: t("detail.mileage", "Mileage"),
      value:
    ...
    <div className="min-h-screen bg-mesh-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card
              padding={false}
              className="overflow-hidden shadow-[0_24px_60px_rgba(0,0,0,0.4),0_0_40px_rgba(212,168,83,0.04)]"
            >
              {images.length > 0 ? (
                <>
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Title & Price */}
            <Card>
              <h1 className="text-2xl font-bold text-mesh-text mb-2">
                {vehicle.title}
              </h1>
        ...
        <div className="space-y-4">
          <p className="text-sm text-mesh-muted">
            {t(
              ...
              "Send a purchase request to the vendor for this vehicle.",
            )}
          </p>
          <Input
          ...
          <Textarea
            ...
            placeholder={t(
              "detail.purchaseMessagePlaceholder",
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-mesh-muted">
            {t(
              "detail.rentalDescription",
              "Select dates and send a rental request.",
            )}
          </p>
          <Input
          ...
          <Textarea
            ...
            placeholder={t(
              "detail.rentalMessagePlaceholder",
              "Add a message to the vendor...",
            )}
            rows={3}
          />
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button
              ...
              disabled={!rentalStart || !rentalEnd}
            >
              {t("detail.sendRequest", "Send Request")}
            </Button>
          </div>
        ...
        <div className="space-y-4">
          <p className="text-sm text-mesh-muted">
            {t(
              ...
              "Let us know why you are reporting this listing.",
            )}
          </p>
          <Select
          ...
          <Textarea
            ...
            placeholder={t(
              "detail.reportDetailsPlaceholder",
