...
const variantClasses: Record<BadgeVariant, string> = {
  default:
    "bg-white/[0.06] text-mesh-muted border-white/[0.08] backdrop-blur-sm",
  success:
    "bg-emerald-500/[0.1] text-emerald-400 border-emerald-500/20 backdrop-blur-sm",
  warning:
    "bg-amber-500/[0.1] text-amber-400 border-amber-500/20 backdrop-blur-sm",
  ...
  sold: "bg-amber-500/15 text-amber-400 border-amber-500/30 backdrop-blur-sm",
};
